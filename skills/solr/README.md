...
This directory contains **three Solr-focused AI skills** plus an evals harness, for use with Claude Code, OpenCode, and any OpenAI-compatible local LLM.
...
├── check-setup.sh                  ← diagnostic script (checks all 3 skills)
│
